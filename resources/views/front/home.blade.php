...
<section class="section-0 lazy d-flex bg-image-style dark align-items-center" data-bg="{{asset('assets/images/hello.jpeg')}}">
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Unlock Your Future</h1>
                <p>Explore Countless Career Opportunities!</p>
                {{-- a<div class="banner-btn mt-5"><a href="#" class="btn btn-primary mb-4 mb-sm-0">About Us</a></div> --}}

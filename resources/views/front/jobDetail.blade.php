    ...
    function applyJob(id) {
        if (confirm("Are you sure you want to apply on this job?")) {
            ...
            $.ajax({
                url: '{{ route("applyJob") }}',
                type: 'post',
                data: {id: id, _token: token}, // Pass the CSRF token
                dataType: 'json',
                headers: {
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        alert(response.message); // Show an error message if application failed
                    }
                },
                error: function (xhr, status, error) {
                    console.error(xhr.responseText); // Log any AJAX errors to the console
                }
            });
        }
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        alert(response.message); // Show an error message if save failed
                    }
                },
                error: function (xhr, status, error) {
                    console.error(xhr.responseText); // Log any AJAX errors to the console
